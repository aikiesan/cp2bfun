...
const Eventos = () => {
  ...
  const labels = {
    pt: {
      tag: 'CP2B',
      title: 'Eventos',
      description: 'Artigos, opinioes e relatorios sobre eventos do CP2b.',
      empty: 'Nenhum artigo disponivel no momento.',
      readMore: 'Saiba mais',
    },
    en: {
      tag: 'CP2B',
      title: 'Events',
      description: 'Articles, opinions and reports on CP2b events.',
      ...
      <Container className="py-5">
        ...
        {loading ? (
          ...
          <Row className="justify-content-center text-center">
            <Col lg={6}>
              <i className="bi bi-calendar-event text-success" style={{ fontSize: '4rem', opacity: 0.5 }}></i>
              ...
              <Col lg={4} md={6} key={item.slug}>
                ...
                >
                  ...
                  <Card.Body className="d-flex flex-column">
                    {item.badge && (
                      <Badge bg={item.badge_color || 'primary'} className="mb-2 align-self-start">
                        {item.badge}
                      </Badge>
                    )}
