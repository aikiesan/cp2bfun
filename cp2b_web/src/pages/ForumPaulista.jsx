...
const content = {
  pt: {
    ...
    program: [
      ...
      { time: '10:00', title: 'Mesa: Financiamento para P&D' },
      { time: '10:45', title: 'Mesa: Eixos Temáticos do CP2b' },
      { time: '12:00', title: 'Brunch no Gramado + Pôsteres Temáticos', highlight: true },
  ...
  en: {
    ...
    program: [
      ...
      { time: '10:00', title: 'Table: R&D Funding Sources' },
      { time: '10:45', title: 'Table: CP2b Research Axes' },
      { time: '12:00', title: 'Lawn Brunch + Thematic Posters', highlight: true },
