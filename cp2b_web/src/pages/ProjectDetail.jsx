...
import { fetchProjectArticle } from '../services/api';
...
const ProjectsDetail = () => {
  ...
  const labels = {
    pt: {
      notFound: 'Projeto nao encontrada',
  ...
  if (!article) {
    return (
      <Container className="py-5 text-center">
        ...
        <Button as={Link} to="/projetos" variant="primary" className="mt-3">{labels.backBtn}</Button>
      </Container>
    );
  }
    ...
    <article className="py-5">
      ...
      <Container style={{ maxWidth: '800px' }}>
        ...
        <div className="d-flex justify-content-between align-items-center border-top pt-4">
            <Button as={Link} to="/projetos" variant="outline-dark" className="rounded-pill px-4">
