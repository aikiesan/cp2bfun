...
const SCHEDULE = [
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        pt: { time: '10h – 10h45', title: 'Mesa de Diálogo: Fontes de financiamento para P&D', description: 'Instrumentos de fomento, integração entre fontes de financiamento e redução do gap entre pesquisa e aplicação.' },
        en: { time: '10:00 – 10:45', title: 'Dialogue Table: R&D Funding Sources', description: 'Promotion instruments, integration between funding sources, and narrowing the gap between research and application.' },
        speakers: [
      ...
      {
        sessionId: 'eixos',
        pt: { time: '10h45 – 12h', title: 'Mesa: Apresentações do CP2b – Eixos Temáticos' },
        en: { time: '10:45 – 12:00', title: 'Table: CP2b Presentations – Research Axes' },
        speakers: [
          ...
          { name: 'Luis Alberto Follegatti Romero', role: { pt: 'Eixo 5 — Bioprodutos', en: 'Axis 5 — Bioproducts' }, inst: 'USP Poli', isModerator: false },
