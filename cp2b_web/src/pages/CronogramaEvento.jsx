...
const SCHEDULE = [
  {
    ...
    sessions: [
      ...
      {
        sessionId: 'abertura',
        pt: { time: '9h30 – 10h', title: 'Mesa de Abertura Institucional', description: 'Boas-vindas, contextualização do evento e formalização de parcerias estratégicas para o desenvolvimento do setor de biogás e bioprodutos.' },
      ...
      {
        sessionId: 'patrocinadores',
        pt: { time: '10h – 10h30', title: 'Patrocinadores e Formalização da Parceria', description: 'Vídeo institucional da Equinor, palestra institucional da Clean e formalização da parceria entre CP2b, Equinor e CNPEM.' },
        en: { time: '10:00 – 10:30', title: 'Sponsors & Partnership Formalization', description: 'Equinor institutional video, Clean institutional talk, and formalization of the partnership between CP2b, Equinor and CNPEM.' },
        speakers: [
          { name: 'Bruna de Souza Moraes', role: { pt: 'Diretora do CP2b', en: 'CP2b Director' }, inst: 'CP2b / UNICAMP', isModerator: false },
          { name: 'Andrea Achoa', role: { pt: 'Diretora de PD&I', en: 'RD&I Director' }, inst: 'Equinor', isModerator: false },
          { name: 'Mário Tyago Murakami', role: { pt: 'Diretor da Unidade de Biorrenováveis', en: 'Director, Bio-renewables Unit' }, inst: 'CNPEM', isModerator: false },
        ],
      },
      {
        sessionId: 'financiamento',
        pt: { time: '10h30 – 11h15', title: 'Mesa de Diálogo: Fontes de financiamento para P&D', description: 'Instrumentos de fomento, integração entre fontes de financiamento e redução do gap entre pesquisa e aplicação.' },
        en: { time: '10:30 – 11:15', title: 'Dialogue Table: R&D Funding Sources', description: 'Promotion instruments, integration between funding sources, and narrowing the gap between research and application.' },
        speakers: [
      ...
      {
        sessionId: 'eixos',
        pt: { time: '11h15 – 12h15', title: 'Mesa: Apresentações do CP2b – Eixos Temáticos' },
        en: { time: '11:15 – 12:15', title: 'Table: CP2b Presentations – Research Axes' },
        speakers: [
          { name: 'Bruna de Souza Moraes', role: { pt: 'Moderadora', en: 'Moderator' }, inst: 'CP2b / UNICAMP', isModerator: true },
          { name: 'Rubens Augusto Camargo Lamparelli', role: { pt: 'Eixo 1 — NIPE', en: 'Axis 1 — NIPE' }, inst: 'UNICAMP', isModerator: false },
          { name: 'Lucas Tadeu Fuess', role: { pt: 'Eixo 2 — Vinhaça', en: 'Axis 2 — Vinasse' }, inst: 'USP São Carlos', isModerator: false },
          { name: 'Denis Miranda', role: { pt: 'Eixo 2 — Resíduos Alimentares', en: 'Axis 2 — Food Waste' }, inst: 'UNICAMP', isModerator: false },
          { name: 'Hilman Ibnu Mahdi', role: { pt: 'Eixo 5 — Bioprodutos', en: 'Axis 5 — Bioproducts' }, inst: 'USP Poli', isModerator: false },
          { name: 'Renata Rodriguez', role: { pt: 'Eixos 6 e 7 — Educação e Difusão', en: 'Axes 6 & 7 — Education & Outreach' }, inst: 'CP2b', isModerator: false },
          { name: 'Sofia Silva', role: { pt: 'Eixos 6 e 7 — Educação e Difusão', en: 'Axes 6 & 7 — Education & Outreach' }, inst: 'CP2b', isModerator: false },
        ],
      },
      {
        sessionId: 'parceria-ki',
        pt: { time: '12h15 – 12h30', title: 'Parceria KI – CP2b', description: 'Chamada para o brunch e espaço do empreendedorismo.' },
        en: { time: '12:15 – 12:30', title: 'KI – CP2b Partnership', description: 'Call to the brunch and entrepreneurship space.' },
        speakers: [],
      },
    ],
  },
    ...
    sessions: [
      {
        ...
        pt: {
          ...
          description: 'Pôsteres Temáticos: Governança e Regulação · Sustentabilidade e Economia Circular · Pesquisa, Desenvolvimento e Inovação · Economia e Modelos de Negócio · Espaço de Networking',
        },
        en: {
          time: '12:30 – 14:30',
          title: 'Lawn Brunch + Parallel Activities',
          description: 'Thematic Posters: Governance & Regulation · Sustainability & Circular Economy · R&D&I · Economics & Business Models · Networking Space',
        },
        speakers: [],
      },
    ],
  },
  {
    ...
    sessions: [
      {
        sessionId: 'painel1',
        pt: { time: '14h30 – 15h30', title: 'Painel 1 — Integração Academia-Indústria: Desafios e Oportunidades no mercado do biogás e biometano', description: 'Integração entre pesquisa, inovação e mercado; transferência de tecnologia e desenvolvimento do setor.' },
        en: { time: '14:30 – 15:30', title: 'Panel 1 — Academia-Industry Integration: Challenges and Opportunities in the biogas and biomethane market', description: 'Integration between research, innovation, and market; technology transfer and sector development.' },
        speakers: [
          { name: 'Renata Piacentini Rodriguez', role: { pt: 'Moderadora', en: 'Moderator' }, inst: 'UNIFAL / CP2b', isModerator: true },
          { name: 'Giovana Fernanda Dionísio', role: { pt: 'Inovação', en: 'Innovation' }, inst: 'Comgás', isModerator: false },
          { name: 'Lara de Oliveira Arinelli', role: { pt: 'P&D Baixo Carbono', en: 'Low Carbon R&D' }, inst: 'Equinor Brasil', isModerator: false },
          { name: 'Priscila Rosseto Camiloti', role: { pt: 'Pesquisadora', en: 'Researcher' }, inst: 'IEE USP / CP2b', isModerator: false },
        ],
      },
      {
        sessionId: 'painel2',
        pt: { time: '15h30 – 16h30', title: 'Painel 2 — Ecossistema para o desenvolvimento do mercado de biogás e biometano: Políticas públicas e Combustível do Futuro', description: 'Regulação, políticas públicas, governança e desenvolvimento do setor.' },
        en: { time: '15:30 – 16:30', title: 'Panel 2 — Ecosystem for biogas and biomethane market development: Fuel of the Future and other Public Policies', description: 'Regulation, public policies, governance, and sector development.' },
        speakers: [
