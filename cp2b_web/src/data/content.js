...
export const newsItems = {
  pt: [
    ...
    },
    {
      ...
      badge: 'Artigo',
      badgeColor: 'info',
      title: 'O papel estratégico do Biogás na COP30 em Belém',
      description: 'A COP na Amazônia destaca soluções baseadas na natureza. O biogás surge como tecnologia chave para a bioeconomia da floresta e descarbonização.',
      link: '#'
    },
    {
      id: 1,
  ...
  en: [
    ...
    },
    {
      ...
      badge: 'Article',
      badgeColor: 'info',
      title: 'The strategic role of Biogas at COP30 in Belém',
      description: 'COP in the Amazon highlights nature-based solutions. Biogas emerges as a key technology for the forest bioeconomy and decarbonization.',
      link: '#'
    },
    {
      id: 1,
...
export const flagshipProjects = {
  pt: [
    ...
    {
      id: 'p2',
      title: 'Living-Lab de Resíduos Sólidos Urbanos (OFMSW)',
      description: 'Planta piloto para gestão de resíduos de restaurantes universitários usando reator de duas fases, produzindo biohidrogênio e biometano (Biohitano) para ônibus do campus.',
      image: '/assets/DSC00617-1024x683.jpg'
    }
  ],
  en: [
    {
      id: 'p1',
      title: 'Demonstration Unit in Agro-industrial Cooperative',
      description: 'Anaerobic digestion system processing agro-industrial retail waste to generate electricity (189 MWh/year) or biomethane, replacing diesel in fleets.',
      image: '/assets/gas-1.jpg'
    },
    {
      id: 'p2',
...
export const sdgMap = {
  ...
  3: '/assets/3-saude-e-bem-estar.jpeg',
  4: '/assets/4-educacao-de-qualidade.jpeg',
  5: '/assets/5-igualdade-de-genero.jpeg',
  6: '/assets/6-agua-potavel-e-saneamento.jpeg',
  7: '/assets/7-energia-acessivel-e-limpa.jpeg',
  8: '/assets/8-trabalho-decente-e-crescimento-economico.jpeg',
  9: '/assets/9-industria-inovacao-e-infraestrutura.jpeg',
  10: '/assets/10-reducao-das-desigualdades.jpeg',
  11: '/assets/11-cidades-e-comunidades-sustentaveis.jpeg',
  12: '/assets/12-consumo-eproducao-responsaveis.jpeg',
  13: '/assets/13-acao-contra-a-mudanca-global-do-clima.jpeg',
  14: '/assets/14-vida-na-agua.jpeg',
  15: '/assets/15-vida-terestre.jpeg',
  16: '/assets/16-paz-justica-e-instituicoes-eficazes.jpeg',
  17: '/assets/17-parcerias-e-meios-de-implementacao.jpeg'
};
...
export const teamMembers = [
  {
    ...
    members: [
      ...
      { name: 'Jens Bo Holm-Nielsen', role: 'Pesquisador Responsável na Instituição Parceira', institution: 'Aalborg University (AAU)' },
      { name: 'José Octavio Armani Paschoal', role: 'Pesquisador Responsável na Instituição Parceira', institution: '-' },
      { name: 'Juliana Paula da Silva Ulian', role: 'Pesquisador Responsável na Instituição Parceira', institution: 'FEM/UNICAMP' },
      { name: 'Leidiane Mariani', role: 'Pesquisador Responsável na Instituição Parceira', institution: 'Amplum Biogás' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Luiz Gustavo Antonio de Souza', role: 'Pesquisador Associado', institution: 'NIPE/UNICAMP' },
...
export const homeContent = {
  pt: {
    ...
    solutions: {
      ...
      subtitle: 'Infraestrutura analítica multiusuária, serviços especializados e modelos flexíveis de cooperação tecnológica — da bancada (TRL 2) à planta piloto (TRL 6).',
      servicesLabel: 'serviços técnicos especializados',
      labsLabel: 'laboratórios centrais',
      trlValue: 'TRL 2–6',
      trlLabel: 'da bancada ao piloto',
      leadLabel: 'Coordenação',
  ...
  en: {
    ...
    solutions: {
      ...
      subtitle: 'Multi-user analytical infrastructure, specialized services and flexible technological cooperation models — from bench (TRL 2) to pilot plant (TRL 6).',
      servicesLabel: 'specialized technical services',
      labsLabel: 'core laboratories',
      trlValue: 'TRL 2–6',
      trlLabel: 'bench to pilot',
      leadLabel: 'Scientific lead',
