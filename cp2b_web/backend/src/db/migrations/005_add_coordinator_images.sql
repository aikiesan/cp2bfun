...
ADD COLUMN IF NOT EXISTS coordinator_image VARCHAR(500),
ADD COLUMN IF NOT EXISTS sub_coordinator VARCHAR(255),
ADD COLUMN IF NOT EXISTS sub_coordinator_image VARCHAR(500);
